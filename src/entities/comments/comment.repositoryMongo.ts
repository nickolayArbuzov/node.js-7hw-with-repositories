...
import { CommentModel } from './schema/comment.interface';
...
@Injectable()
export class CommentRepositoryMongo implements ICommentRepositoryInterface {
  constructor(
    @Inject('COMMENT_MONGOOSE')
    private commentRepository: Model<CommentModel>,
  ) {}
